            ...
            <div class="card__body">
                <form class="form" id="importForm" enctype="multipart/form-data">
                    <div class="form__group">
                        ...
                        <input class="form__input" type="file" id="excelFile" name="excelFile" accept=".xlsx, .csv" required>
                        <div class="form-text" style="margin-top: 0.5em; color: var(--text-color-muted);">Accepted formats: <b>.xlsx</b>, <b>.csv</b></div>
                    </div>
                    <div class="form__group">

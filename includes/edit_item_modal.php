            ...
            <div class="card__body">
                <form class="form" id="editItemForm">
                    ...
                    <div class="form__group">
                        ...
                        <input type="text" name="item_barcode" id="edit_item_barcode" class="form__input">
                    </div>
                    <div class="form__row">
                        <div class="form__group">
                            <label class="form__label">Quantity</label>
                            <input type="number" name="item_quantity" id="edit_item_quantity" class="form__input" value="0" min="0">
                        </div>
                        <div class="form__group">

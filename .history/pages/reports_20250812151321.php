    ...
    <div class="page">
        ...
        <div class="card mb-4">
            <div class="card__header">
                <h2 class="card__title">Item Usage Trends (In vs. Out)</h2>
                <p class="text-muted">Visualize stock movements over time.</p>
            </div>
            <div class="card__body">
                <form id="usageTrendsForm" class="d-flex align-center gap-2 mb-3">
                    <label for="usage_view_type" class="form-label">View By:</label>
                    <select id="usage_view_type" name="view_type" class="form-select">
                    ...
                    <div class="usage-custom-dates d-flex align-center gap-2" style="display: none;">
                        <label for="usage_start_date" class="form-label">From:</label>
                        <input type="text" id="usage_start_date" name="start_date" class="form-control date-picker" placeholder="YYYY-MM-DD">
                        <label for="usage_end_date" class="form-label">To:</label>
                        <input type="text" id="usage_end_date" name="end_date" class="form-control date-picker" placeholder="YYYY-MM-DD">
        ...
        <div class="grid grid--2-cols gap-4 mb-4">
            <div class="card">
                ...
                <div class="card__body">
                    <?php
                    $stock_overview_data = [];
                    $sql_stock_overview = "SELECT name, quantity FROM items ORDER BY name ASC";

...
<div class="sidebar">
    ...
    <nav class="sidebar__nav">
        <ul class="sidebar__list">
            ...
            <li class="sidebar__item <?php echo $current_page === 'email_settings' ? 'sidebar__item--active' : ''; ?>">
                <a href="index.php?page=email_settings" class="sidebar__link sidebar__button">
                    <i class="fas fa-envelope"></i> <!-- Icon for Email Settings -->

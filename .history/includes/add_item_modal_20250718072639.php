                ...
                <form class="form" id="addItemForm">
                    ...
                    <div class="form__row">
                        <div class="form__group">
                            ...
                            <input type="number" name="item_quantity" class="form__input" value="0" min="0" required>
                        </div>
                        <div class="form__group">
                    ...
                    <div class="form__row">
                        ...
                        <div class="form__group">
                            ...
                            <input type="number" name="item_min_stock_level" class="form__input" value="0" min="0">
                        </div>
                    </div>
                    <div class="form__row">
                        <div class="form__group">
                            <label class="form__label">Max Stock Level</label>
                            <input type="number" name="item_max_stock_level" class="form__input" value="0" min="0">
                        </div>
                        <div class="form__group">
                    ...
                    <div class="form__group">
                        <label class="form__label">Reason/Purpose for Adding <span class="required-indicator">*</span></label>
                        <textarea name="item_reason" class="form__input" required></textarea>
                    </div>

            ...
            <div class="card__body">
                <form class="form" id="importForm" enctype="multipart/form-data">
                    <div class="form__group">
                        ...
                        <div class="form-text" style="margin-top: 0.5em; color: var(--text-color-muted);">
                            Accepted formats: <b>.xlsx</b>, <b>.xls</b>, <b>.csv</b>. 
                            <a href="assets/templates/sample_inventory_import.csv" target="_blank" style="text-decoration: underline;">Download sample template</a>
                        </div>
                    </div>
                    <div class="form__group">
                ...
                <div id="importSummary" class="mt-4" style="display: none; background: #fff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); padding: 1em;">
                    ...
                    <p>New items added: <span id="itemsAdded"></span></p>
                    <p>Existing items updated: <span id="itemsUpdated"></span></p>
                    <p>Items skipped (not imported): <span id="itemsSkipped"></span></p>

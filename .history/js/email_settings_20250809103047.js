$(document).ready(function() {
    ...
    $('#save-recipient-btn').on('click', function() {
        $.ajax({
            url: '../ajax/add_notification_recipient.php',
            type: 'POST',
    ...
    $('#update-recipient-btn').on('click', function() {
        $.ajax({
            url: '../ajax/update_notification_recipient.php',
            type: 'POST',
    ...
    $('.status-toggle').on('change', function() {
        ...
        $.ajax({
            url: '../ajax/update_notification_recipient_status.php',
            type: 'POST',
            ...
            success: function(response) {
                ...
                alert('Recipient status updated successfully.');
            },
            error: function() {
                alert('Failed to update recipient status.');
    ...
    $('.delete-recipient-btn').on('click', function() {
        if (confirm('Are you sure you want to delete this recipient?')) {
            ...
            $.ajax({
                url: '../ajax/delete_notification_recipient.php',
                type: 'POST',
                data: { id: id },
                success: function(response) {

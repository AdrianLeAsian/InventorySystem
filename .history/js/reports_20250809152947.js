    ...
    function fetchUsageTrends() {
        ...
        fetch(`ajax/get_usage_trends.php?${params.toString()}`)
            ...
            .then(data => {
                if (data.success) {
                    ...
                    if (usageTrendsChart) {
                        ...
                        usageTrendsCtx.innerHTML = ''; // Clear canvas
                    }
                    usageTrendsCtx.insertAdjacentHTML('afterend', `<p class="text-center text-muted">No 'stock out' data available for the selected period to display usage trends.</p>`);
            ...
            .catch(error => {
                ...
                usageTrendsCtx.insertAdjacentHTML('afterend', `<p class="text-center text-muted">An error occurred while fetching usage trends data.</p>`);
            });
    }

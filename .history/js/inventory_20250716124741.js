...
function toggleModal(modalId, show) {
    ...
    if (modal) {
        if (show) {
            ...
            console.log(`[toggleModal] ${modalId} class 'is-hidden' removed. ClassList: ${modal.classList}`);
        } else {
            modal.classList.add('is-hidden');
            console.log(`[toggleModal] ${modalId} class 'is-hidden' added. ClassList: ${modal.classList}`);
        }
    } else {

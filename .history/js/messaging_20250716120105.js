        ...
        fetch('ajax/get_sms_recipients.php')
            ...
            .then(data => {
                ...
                if (data.success && data.recipients.length > 0) {
                    ...
                    recipientsTableBody.innerHTML = '<tr><td colspan="3">No recipients found.</td></tr>';
                }
            })
            .catch(error => {
                console.error('Error loading recipients:', error);
                recipientsTableBody.innerHTML = '<tr><td colspan="3" style="color: red;">No recipients could be loaded. Please try adding one or check your server connection.</td></tr>';
            });
    }

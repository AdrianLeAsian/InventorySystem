    ...
    function loadRecipients() {
        fetch('ajax/get_sms_recipients.php')
            ...
            .catch(error => {
                ...
                recipientsTableBody.innerHTML = '<tr><td colspan="3" style="color: red;">Failed to load recipients. Please ensure the server is running or add new recipients.</td></tr>';
            });
    }

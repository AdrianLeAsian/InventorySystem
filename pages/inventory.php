                                        ...
                                        <?php if (!empty($all_items)): ?>
                                            <?php foreach ($all_items as $item): ?>
                                                <?php
                                                    ...
                                                    $status_class_btn = 'btn btn--success'; // For the status button
                                                ...
                                                ?>
                                                <tr data-item-id="<?php echo htmlspecialchars($item['id']); ?>" data-category-id="<?php echo htmlspecialchars($item['category_id']); ?>" class="table__row stock-<?php echo $stock_status; ?>">

...
$recipients_stmt = $conn->prepare("SELECT * FROM notification_recipients ORDER BY name ASC");
                            ...
                            <tr data-id="<?= $recipient['id'] ?>">
                                ...
                                <td>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input status-toggle" id="status-<?= $recipient['id'] ?>" data-id="<?= $recipient['id'] ?>" <?= $recipient['status'] ? 'checked' : '' ?>>
                                        <label class="custom-control-label" for="status-<?= $recipient['id'] ?>"><?= $recipient['status'] ? 'Enabled' : 'Disabled' ?></label>
                                    </div>
                                </td>
                                <td>

...
-- Insert Items
INSERT INTO items (name, description, barcode, quantity, low_stock_threshold, category_id, created_at) VALUES
('Laptop Pro X', 'High-performance laptop', 'LPX001', 15, 5, 1, NOW()),
('Wireless Mouse', 'Ergonomic wireless mouse', 'WM002', 50, 10, 1, NOW()),
('Smart Speaker', 'Voice-controlled smart speaker', 'SS003', 25, 8, 1, NOW()),
('Coffee Maker', '12-cup programmable coffee maker', 'CM004', 10, 3, 2, NOW()),
('Toaster Oven', 'Compact toaster oven', 'TO005', 8, 2, 2, NOW()),
('Desk Lamp LED', 'Adjustable LED desk lamp', 'DL006', 30, 7, 3, NOW()),
('Notebook A4', '200-page A4 notebook', 'NB007', 100, 20, 3, NOW()),
('The Great Novel', 'Bestselling fiction book', 'TGN008', 40, 15, 4, NOW()),
('Coding Handbook', 'Comprehensive guide for developers', 'CHB009', 20, 5, 4, NOW()),
('T-Shirt Cotton', 'Plain white cotton t-shirt', 'TCC010', 75, 25, 5, NOW()),
('Jeans Slim Fit', 'Blue denim slim fit jeans', 'JSF011', 35, 10, 5, NOW()),
('Organic Coffee Beans', '1kg bag of organic coffee beans', 'OCB012', 60, 15, 6, NOW()),
('Energy Drink 250ml', 'High caffeine energy drink', 'ED013', 120, 30, 6, NOW()),
('Webcam HD', 'Full HD webcam with mic', 'WCH014', 22, 6, 1, NOW()),
('External SSD 1TB', 'Portable 1TB SSD', 'ESSD015', 18, 4, 1, NOW()),
('Blender Pro', 'High-speed professional blender', 'BP016', 7, 2, 2, NOW()),
('Stapler Heavy Duty', 'Heavy duty office stapler', 'SHD017', 45, 10, 3, NOW()),
('Pen Set Gel', 'Assorted gel pen set', 'PSG018', 80, 20, 3, NOW()),
('Mystery Thriller', 'Gripping mystery novel', 'MT019', 30, 8, 4, NOW()),
('Hoodie Fleece', 'Comfortable fleece hoodie', 'HF020', 55, 18, 5, NOW());
...
-- Example 'in' movements (to show mixed log types, though usage trends focus on 'out')
INSERT INTO inventory_log (item_id, type, quantity_change, log_date) VALUES
(1, 'in', 5, DATE_SUB(CURDATE(), INTERVAL 1 DAY)),
(2, 'in', 10, DATE_SUB(CURDATE(), INTERVAL 2 DAY)),
(7, 'in', 20, DATE_SUB(CURDATE(), INTERVAL 5 DAY)),
(10, 'in', 15, DATE_SUB(CURDATE(), INTERVAL 10 DAY)),
(1, 'in', 10, DATE_SUB(CURDATE(), INTERVAL 1 MONTH)),
(2, 'in', 20, DATE_SUB(CURDATE(), INTERVAL 3 MONTH)),
(7, 'in', 40, DATE_SUB(CURDATE(), INTERVAL 6 MONTH)),
(10, 'in', 30, DATE_SUB(CURDATE(), INTERVAL 9 MONTH));
